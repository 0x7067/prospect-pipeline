...
- Retratos: as fotos publicadas das duas profissionais foram mantidas. As únicas versões disponíveis no domínio oficial (`assets/team-gleida.jpg` 319×302, `assets/team-elizane.jpg` 234×253) são recortes de captura de tela já desfocados na origem, então o desfoque não desaparece; o que mudou foi a exibição. O retrato passou de 150 px para 112 px (92 px no mobile), com moldura circular branca, leve vinheta, ajuste de contraste/saturação e enquadramento por retrato — a ampliação deixa de acentuar o desfoque e a suavidade lê como foto de arquivo, não como defeito. Substituir por fotografias em resolução maior continua sendo troca direta dos dois arquivos.
