...
Creative North Star: Shape the hotel homepage like a considered arrival: a compact central-Curitiba welcome that moves from room confidence to breakfast and amenities, then lands on the direct reservation promise without the current social-feed sprawl.
